...
export function welcomeText() {
  return (
    'سلام نسرین خانم! 🌼\n' +
    'من چری ام — این پسره من رو به این دنیا اورد تا تو موبایل شما خونه کنم.\n' +
    'بهم گفته هر آهنگی شما برام فرستادی (یا اسمش + خوانندش)  ویدیوش رو بیارم 🎬\n\n' +
...
export function deliveredCaption() {
  const lines = [
    'رسید! 🎬 بفرما، همون چیزیه که خواسته بودی؟ 😔 (شرمندم بابت کیفیت) 🌼',
    'آوردمش! 🎬 امیدوارم خنده اورده باشم رو لبهات 😉',
    'اینم از این 🎬 بذار پخش شه، منم همین‌جام  نگات میکنم 🎧',
  ];
